...
import '../addition files/locality.dart';
import '../addition files/price.dart';
import '../addition files/sortpage.dart';

class flats extends StatefulWidget {
  const flats({super.key});
...
class _flatsState extends State<flats> {
  Widget singleflat(String flatname, String amount, String Address, String bds,
